...
#include "AnimNode_MIBlendSpacePlayer.generated.h"

class UBlendSpace;

USTRUCT(BlueprintInternalUseOnly)
struct MOVEIT_API FAnimNode_MIBlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
	GENERATED_BODY()

	friend class UAnimGraphNode_Base;
	friend class UAnimGraphNode_AdditiveBlendSpace;
...
public:	
	FAnimNode_MIBlendSpacePlayer() = default;
