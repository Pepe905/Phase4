...
#include "AnimGraphNode_TranslatePoleVectors.generated.h"

UCLASS()
class MOVEITEDITOR_API UAnimGraphNode_TranslatePoleVectors : public UAnimGraphNode_LocalSkeletalControlBase
{
	GENERATED_BODY()

public:
	UPROPERTY(EditAnywhere, Category = Settings)
	FAnimNode_TranslatePoleVectors Node;
