...
#include "AnimGraphNode_JumpingCompression.generated.h"

/**
 * 
 */
UCLASS()
class MOVEITEDITOR_API UAnimGraphNode_JumpingCompression : public UAnimGraphNode_LocalSkeletalControlBase
{
	GENERATED_BODY()
	
public:
	UPROPERTY(EditAnywhere, Category=Settings)
	FAnimNode_JumpingCompression Node;
